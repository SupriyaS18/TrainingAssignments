...
public class NewTest {
	public WebDriver driver;
	 ...
	 @Test public void scenario1() throws InterruptedException {
	  ...
	  driver.findElement(By.xpath("//input[@id='password']")).sendKeys("secret_sauce"); driver.findElement(By.id("login-button")).click();
	  Thread.sleep(2500); driver.findElement(By.xpath("//button[@id='add-to-cart-sauce-labs-bolt-t-shirt']")).click();
	 ...
	 Thread.sleep(3500); String title=driver.getTitle();
